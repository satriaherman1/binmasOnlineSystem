    ...
    <main>
        ...
        <div class="container">
          <div class="row mx-1 mb-5 mt-2 container-grid-1">
            ...
            <!-- item -->
            <div class="col-md sm-12 mt-4">
              <div class="box mx-auto" style="width: 300px; height:fit-content; border-radius:10px" onclick="document.location.href='li.html'" >
                  <div class="header text-center">
          ...
          <!-- item -->
            ...
            <div class="col-md sm-12 mt-4 mb-4">
                <div class="box mx-auto" style="width: 300px; height:fit-content; border-radius:10px" onclick="document.location.href='dds-usaha.html'">
                    <div class="header text-center">
