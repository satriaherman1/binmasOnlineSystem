...
Route::prefix('/laporan')->group(function(){
    ...
    Route::get('/dds/dds-usaha' , function(){
        return view('bhabin/laporan/dds/dds-usaha');
    });
    Route::get('/dds/dds-kosan-dan-apartemen' , function(){
        return view('bhabin/laporan/dds/dds-kosan-dan-apartemen');
    });
});

Route::get('/pusat-informasi' , function(){
    return view('bhabin/pusat-informasi/index');
});